...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$UserService$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/UserService.js [ssr] (ecmascript)"); // Fixed path
(()=>{
...
function UserCard({ user, isSaved = false, onSave, onUpdate }) {
    ...
    const handleSaveEdit = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$UserService$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["userService"].updateUser(user.id, editForm);
            setEditing(false);
            setEditForm({});
            onUpdate?.();
    ...
    const handleDelete = async ()=>{
        if (confirm('Are you sure you want to delete this user?')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$UserService$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["userService"].deleteUser(user.id);
                onUpdate?.();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8571d12._.js.map